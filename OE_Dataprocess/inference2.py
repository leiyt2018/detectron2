...
def get_parser():
    ...
    parser.add_argument(
        ...
        default = "../configs/PascalVOC-Detection/faster_rcnn_R_50_C4.yaml",
        metavar="FILE",
    ...
    if args.input_dir:
        ...
        # with tqdm.tqdm(10) as pbar:
            for path in tqdm.tqdm(os.listdir(args.input_dir)):
                ...
                # f_label.write()
                pbar.update(1)
                visualized_output.save('./data128/{}'.format(path))
                j = j +1
        # f_data.close()

    inference_output_dir = '/home/leiyvtian/datasets/ImageNet1k_Val_OE'
    with open(os.path.join(inference_output_dir, 'coco_instances_results1.json'), 'w') as fp:
