...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        # labels = _create_text_labels(classes, scores, ['pedestrian', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle', 'bicycle', 'traffic light', 'traffic sign'])
    ...
    def draw_proposals_predictions(self, predictions):
        """
        Draw instance-level prediction results on an image.
        ...
        Returns:
            output (VisImage): image object with visualizations.
        """
        boxes = predictions.proposal_boxes # if predictions.has("pred_boxes") else None
        scores = predictions.objectness_logits # if predictions.has("scores") else None
        # classes = predictions.pred_classes.tolist() if predictions.has("pred_classes") else None
        classes = None
    ...
    def draw_max_proposals_predictions(self, predictions):
        """
        Draw instance-level prediction results on an image.
        ...
        boxes.tensor = boxes.tensor[ind,:].unsqueeze(0)
        scores = scores[ind].unsqueeze(0)
